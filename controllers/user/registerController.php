...
if (isset($_POST['register'])) {
    ...
    if (!empty($_POST['civility'])) {
        ...
        if ($_POST['civility'] == 'Monsieur' || $_POST['civility'] == 'Madame' || $_POST['civility']) {
   ...
   //TODO on verrifi que le chemp ne pas vide
    ...
    if (count($formErrors) == 0) {
        if ($user->addUser()) {
            $formErrors['add'] = 'votr formulair a bien été envoyer';
        } else {
            $formErrors['fail'] = 'votre formulair na put appoutire';
        }
    }
}
